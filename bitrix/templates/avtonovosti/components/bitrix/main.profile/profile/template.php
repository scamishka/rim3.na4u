...
<?endif?>
    ...
    <?if(isset($arParams['USER_PERSONAL_INFO']) && $arParams['USER_PERSONAL_INFO'] == 'Y'):?>
...
<?endif;?>
    ...
    <?if(isset($arParams['USER_WORK_INFO']) && $arParams['USER_WORK_INFO'] == 'Y'):?>
...
<table class="data-table profile-table">
    ...
    <?if(isset($arParams['USER_ADMIN_NOTES']) && $arParams['USER_ADMIN_NOTES'] == 'Y'):?>

        <?if($arResult["IS_ADMIN"]):?>
            <div class="profile-link profile-user-div-link">
                <a title="<?=GetMessage("USER_SHOW_HIDE")?>" href="javascript:void(0)" onclick="SectionClick('admin')">
                    <?=GetMessage("USER_ADMIN_NOTES")?></a>
            </div>
    ...
    <?endif;?>
    <div class="profile-link profile-user-div-link">
        <a title="<?=GetMessage("main_profile_public_banner")?>" href="javascript:void(0)" >
            <?=GetMessage("main_profile_public_banner")?></a>
    </div>
	<?// ********************* User properties ***************************************************?>
